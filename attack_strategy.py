...
class SingleAttack(AttackStrategy):#普通攻擊（次氯酸水）的攻擊方式
    def attack(self, enemies : list, bullet):
        for en in enemies:#逐個搜索場上的病毒
...
class AOE(AttackStrategy):
    def attack(self, enemies : list, bullet):#酒精的攻擊方式
        for en in enemies:
            '''
