        ...
        while not game_quit:
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.MOUSEBUTTONDOWN:
                    ...
                    self.bullet.add(self.player.get_pos_x(),self.player.get_pos_y(),mouse_x,mouse_y,self.virus.get())
                elif (key_pressed[pygame.K_SPACE] or key_pressed_2[pygame.K_SPACE] or key_pressed_3[pygame.K_SPACE]):
                     self.player.shot(mouse_x,mouse_y)
                     self.bullet.alcohol_shot(self.player.get_pos_x(),self.player.get_pos_y(),mouse_x,mouse_y,self.virus.get())
